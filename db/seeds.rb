...
application3 = Application.create(
  ...
  description: "The team develops the tooling, algorithmic automation, and systems to bring human and machine intelligence together to build the world's best datasets for developing autonomous vehicles. We are obsessed with building highly usable tools to examine and annotate complex data from different sensors such as lidar, radar, and cameras. You will work with others to develop and improve the core tooling by seeking opportunities for increased usability and areas in which we can apply recent computer vision techniques to aid in the creation of and QA of labeled datasets.",
  url: 'uberjobs.com',
...
date1 = Date.new(2020, 11, 14)
date2 = Date.new(2020, 11, 16)
date3 = Date.new(2020, 12, 0o3)
date4 = Date.new(2020, 11, 20)

interview1 = Interview.create(date: date1, time: '8:00 a.m.', location: 'Zoom', application: application1)
interview2 = Interview.create(date: date2, time: '10:00 a.m.', location: 'Amazon Denver Office', application: application2)
